...
# How to contribute to Cloud CRM
...
Another really useful way to contribute to Cloud CRM is to review other peoples Pull Requests. Having feedback from multiple people is really helpful and reduces the overall time to make a final decision about the Pull Request.

---

# Code Style

We aim for clean, consistent code style. We're using ESlint to check for codestyle issues using the Standard preset (you can run `npm run lint` to lint your code).
...
Thanks again for being a contributor :tada:!
